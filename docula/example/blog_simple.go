...
**Ready to upgrade?** Check out our migration guide and experience the future of documentation!
...
Generate HTML on the server with Go templates.

### **Interactive Islands with HTMX**
Add interactivity with simple HTML attributes.
...
*Added live via reactive updates!* ⚡`
	...
	newPostPath := filepath.Join(postsDir, "real-time-updates.html")
