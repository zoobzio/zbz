...
// Example: cache.ConfigureFromFlux(redis.NewProvider, hodorContract, "cache.yaml")
func ConfigureFromFlux(providerFunc ProviderFunction, hodorContract *hodor.HodorContract, configKey string) (flux.FluxContract, error) {
	return configureFromFluxWithProvider(providerFunc, hodorContract, configKey)
}
